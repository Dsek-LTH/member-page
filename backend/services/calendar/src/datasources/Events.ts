...
export default class Events extends dbUtils.KnexDataSource {
  ...
  updateEvent = (context: context.UserContext, id: UUID, input: gql.UpdateEvent): Promise<gql.Maybe<gql.Event>> =>
  ...
  removeEvent = (context: context.UserContext, id: UUID): Promise<gql.Maybe<gql.Event>> =>
