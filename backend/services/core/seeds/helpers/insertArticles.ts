...
const articles = (memberIds: string[], mandateIds: string[], idx: number): any[] => [
  {
    ...
    author_type: 'Mandate',
    published_datetime: new Date(`${2016 + idx}-05-20 12:20:02`),
    slug: slugify(`Detta är en nyhet från maj${idx}`),
  }, {
    ...
    published_datetime: new Date(`${2017 + idx}-06-20 12:20:02`),
    latest_edit_datetime: new Date('2018-06-21 12:20:02'),
    slug: slugify(`Detta är en redigerad nyhet${idx}`),
  }, {
    header: 'Detta är en nyhet från Ada',
    body: 'Detta är mer ingående information om nyheten från Ada',
  ...
  },
  {
    ...
    published_datetime: new Date(`${2019 + idx}-07-21 12:20:02`),
    slug: slugify(`Detta är en mycket lång nyhet från Ole-Johan${idx}`),
  },
];
...
export default async function insertArticles(
  ...
  return (await knex<Article>('articles').insert(
    [...articles(memberIds, mandateIds, 0),
      ...articles(memberIds, mandateIds, 1),
      ...articles(memberIds, mandateIds, 2),
      ...articles(memberIds, mandateIds, 3)],
