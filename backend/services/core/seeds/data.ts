...
export const seed = async (knex: Knex) => {
  ...
  await knex<Article>('articles').insert([
    {
  ...
  await knex<Song>('songs').insert([
    {
      ...
      created_at: new Date(1098910607000),
      updated_at: new Date(1445521563000),
      melody: 'Rosa på bal',
      category: 'Klassiska Visor',
    },
    {
      ...
      created_at: new Date(1098910606000),
      updated_at: new Date(1445520557000),
