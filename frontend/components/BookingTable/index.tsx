...
import { BookingStatus, Member, useGetBookingsQuery } from '~/generated/graphql';
            ...
            <Table stickyHeader aria-label="sticky table">
                ...
                <TableBody>
                    {bookingRequests.map((bookingItem, index) => (
                        <BookingTableRow key={index} bookingRequest={bookingItem} user={user} onChange={onChange} />
                    ))}
                </TableBody>
            </Table>
        </TableContainer>
